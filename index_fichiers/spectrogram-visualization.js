(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.spectrogramVisualization = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.spectrogramVisualization = spectrogramVisualization;
...
function interpol(min, max) {
  return function y(x) {
    return 1 / (max - min) * x - min / (max - min);
  };
}

function spectrogramVisualization(data, tg) {
  console.time("spectrogram rendering");
  var blocks = data.xmX;
  var nblocks = data.xmX.length;
  var nfreqs = data.xmX[0].length;
  var c = interpolate.hslLong(color.color('red'), color.color('blue'));
  var min = undefined;
  var max = undefined;

  console.time("min/max computation");
  ...
  try {
    for (var _iterator = blocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      min = min ? (_Math = Math).min.apply(_Math, _toConsumableArray(v).concat([min])) : (_Math2 = Math).min.apply(_Math2, _toConsumableArray(v));
      max = max ? (_Math3 = Math).max.apply(_Math3, _toConsumableArray(v).concat([max])) : (_Math4 = Math).max.apply(_Math4, _toConsumableArray(v));
    }
  } catch (err) {
  ...
  console.timeEnd("min/max computation");

  var inter = interpol(min, max);
  var ctx = tg.getContext("2d");
  tg.width = nblocks;
  tg.height = nfreqs;
  // const imageData = ctx.createImageData(nblocks, nfreqs);
  // const uint32array = new Uint32Array(nblocks*nfreqs);
  // const arraybuffer = new ArrayBuffer(4*nblocks*nfreqs);
  // const dv = new DataView(arraybuffer);
  // console.time("draw")
  for (var i = 0; i < nblocks; i++) {
    for (var j = 0; j < nfreqs; j++) {
      // let col = c(inter(data.xmX[i][j]));
      // col = col.substr(1)+'00';
      // uint32array[j*nblocks+i] = parseInt(col, 16);
      // dv.setUint32((j*nblocks+i)*4, parseInt(col, 16), true);
      // let pixelColor = color.color(col);
      // let id = j*nblocks*4+i*4;
      // imageData.data[id] = pixelColor.r;
      // imageData.data[id+1] = pixelColor.g;
      // imageData.data[id+2] = pixelColor.b;
      // imageData.data[id+3] =  255;
      ctx.fillStyle = c(inter(data.xmX[i][j]));
      ctx.fillRect(i, j, 1, 1);
    }
  }
  // const uint32arrayBis = new Uint32Array(arraybuffer);
  // console.log(">", uint32array.buffer, uint32array[0], dv.buffer, dv[0], uint32arrayBis.buffer, uint32arrayBis[0]);
  // const uint8clampedarray = new Uint8ClampedArray(uint32arrayBis.buffer);
  // imageData.data.set(uint8clampedarray)
  // ctx.putImageData(imageData, 0, 0);
  console.timeEnd("draw");
  console.timeEnd("spectrogram rendering");
}
},{"d3-color":2,"d3-interpolate":3}],2:[function(require,module,exports){
